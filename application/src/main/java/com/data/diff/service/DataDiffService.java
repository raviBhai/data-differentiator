...
public interface DataDiffService {
    ...
    /**
     * Save or update the left data {@code fields} for a given object {@code id}.
     *
     * @param fields
    ...
    /**
     * Save or update the right data {@code fields} for a given object {@code id}.
     *
     * @param fields
    ...
    /**
     * Gets the difference between left and right data {@code fields} for a given object {@code id}.
     * @param id
